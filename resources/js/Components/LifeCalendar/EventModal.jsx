        ...
        <ModalContent>
          ...
          <ModalBody>
            <Input
              ...
              onChange={(ev) => setSelectedDateValue(ev.target.value)}
            />
            <Input placeholder="Title" mt={2} onChange={(ev) => setTitle(ev.target.value)} />
            <Textarea
            ...
            />
            <Input placeholder="Type (-3, -2, -1, 0, 1, 2, or 3)" onChange={(ev) => setType(ev.target.value)} />
          </ModalBody>
